			...
			<div class="box box-info">
				<div class="box-header with-border" style="text-align:center">
					...
					<div class="pull-right">
						<h3 class="box-title">Date : {{date('j F Y',strtotime($row->do_date))}}</h3>
					</div>
				</div>
				<div class="box-body">
					<div class="col-md-6">
			            ...
			            <div class="form-group">
			                <label for="spk_doc_code" class="col-sm-4 control-label">SPK Control Number</label>
			                <div class="col-sm-8">
			                   <div class="spk-field">
			             ...
			             <div class="form-group">
			                ...
			                <div class="col-sm-8">
			                   <div class="spk-field">
			                   		<span>{{\App\Models\Dealer::getName($init['dealer_id'])}}</span>
			                   	</div>
			                </div>
			             </div>
			             <hr />
			             ...
			             <div class="form-group">
			                ...
			                <div class="col-sm-8">
			                   <div class="spk-field">
			                   		<span>{{\App\Models\CarModel::getName($init['model_id'])}} {{\App\Models\CarType::getName($init['type_id'])}}</span>
			                   	</div>
			                </div>
			             </div>
			             <div class="form-group">
			             ...
			             <div class="form-group">
			                ...
			                <div class="col-sm-8">
			                   <div class="spk-field">
			                   		<span>{{\App\Models\Bbn::getName($init['bbn_type'])}}</span>
			                   	</div>
			                </div>
			             </div>
			             <hr />
		            	...
		            	<div class="form-group">
			             ...
			             <div style="display:{{($init['payment_method'] == 2) ? 'block' : 'none'}}">
			             	...
			             	<div class="form-group">
					            ...
					            <div class="col-sm-8">
					                <div class="spk-field">
					                   	<span>{{$init['year_duration']}} Months</span>
					                </div>
					            </div>
			             	</div>
			             	<div class="form-group">
