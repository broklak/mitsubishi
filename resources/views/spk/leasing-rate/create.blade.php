	              ...
	              <div class="box-body">
	                ...
	                <div class="form-group">
	                  ...
	                  <div class="col-sm-10">
	                    <select name="car_type_id" class="form-control">
	                    	...
	                    	<option @if(old('car_type_id') == $val->id) selected @endif value="{{$val->id}}">{{\App\Models\CarModel::getName($val->model_id)}} - {{$val->name}}</option>
	                    	@endforeach
	                    </select>
	                  </div>
	                </div>
	                ...
	                <div class="form-group">
			         ...
			         <div class="form-group">
			            ...
			            <div class="col-sm-10">
			               	<input type="text" onkeyup="formatMoney($(this))" class="form-control" name="karoseri" value="{{old('karoseri')}}" id="karoseri" placeholder="Enter Karoseri Price">
			            </div>
			         </div>
