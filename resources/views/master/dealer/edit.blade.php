	                ...
	                <div class="form-group">
	                  ...
	                  <div class="col-sm-10">
	                  	<select class="form-control" name="company_id">
	                  		...
	                  		<option @if($row->company_id == $val->id ) selected="selected" @endif value="{{$val->id}}">{{$val->name}}</option>
	                  		@endforeach
	                  	</select>
	                  </div>
	                 </div>
	                ...
	                <div class="form-group">
	                  ...
	                  <div class="col-sm-10">
	                  	<select name="area" class="form-control">
	                  		...
	                  		<option @if($val->id == $row->area) selected @endif value="{{$val->id}}">{{$val->name}}</option>
	                  		@endforeach
	                  	</select>
	                  </div>
	                </div>
