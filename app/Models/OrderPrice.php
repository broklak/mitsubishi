...
class OrderPrice extends Model
{
    ...
    public static function createData($data) {
    	return parent::create([
    		...
    		'down_payment_amount' => parseMoneyToInteger($data['down_payment_amount']),
    		'down_payment_date' => $data['down_payment_date'],
    		'jaminan_cost_amount' => parseMoneyToInteger($data['jaminan_cost_amount']),
    		'jaminan_cost_percentage' => $data['jaminan_cost_percentage'],
